...
import unitTesting1 from "../../images/unitTesting1.png";
import unitTesting2 from "../../images/unitTesting2.png";
import unitTesting3 from "../../images/unitTesting3.png";
...
export default class Projects extends React.Component {
  ...
  slideshowImages = [
    ...
    {
      name: "Unit Testing with Mocha, Chai, and Sinon",
      image: unitTesting1,
      description: "testing existsByNameLicenseZip",
    },
    {
      name: "Unit Testing (continued)",
      image: unitTesting2,
      description: "testing Model.find()",
    },
    {
      name: "Unit Testing (continued)",
      image: unitTesting3,
      description: "Testing Model.create()",
    },
  ];
  projects = [
    {
